...
// allow us to use process.ENV from environment.env
...
// change connection URL after setting up your team database
...
app.use(
  session({
    // add a SESSION_SECRET string in your .env file, and replace the secret with process.env.SESSION_SECRET
...
// allow PORT override to avoid collisions
const port = 3000;
